...
# @description This script will install Python CLI Boilerplate. The script heavily borrows from
...
#
#   ```
#   curl -sSL https://raw.githubusercontent.com/megabyte-labs/python-cli/master/local/install.sh | sh
#   ```

RELEASES_URL="https://github.com/megabyte-labs/template-python-cli/releases"
